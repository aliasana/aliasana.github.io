              ...
              {ROLES.map((role) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-2 min-w-0">
                    <div className="w-6 h-6 rounded-full bg-black/60 flex items-center justify-center text-[0.65rem]">
                      {role === "Requester" && "RQ"}
                      {role === "Manager" && "MG"}
                      {role === "Governance" && "GV"}
                    </div>
                      ...
                      .map((phase) => {
                        ...
                        return (
                          <div
                            ...
                            `}
                          >
                            <p className="font-medium mb-0.5 leading-tight text-[0.72rem] sm:text-[0.8rem]">
                              {phase.title}
                            </p>
                            <p className="text-[0.6rem] sm:text-[0.75rem] text-muted-foreground leading-tight">
                              {phase.detail}
                            </p>
                          </div>
                        );
