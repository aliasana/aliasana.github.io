  ...
  transform: scale(0.95);
      ...
      <div className="w-full px-4 md:px-8 z-10 text-center pt-24 md:pt-32 flex flex-col items-center">
        ...
        >
          ...
          {/* floating sparkles */}
          <span className="spark" style={{ top: "-10px", left: "8%" }} />
          <span className="spark gold" style={{ top: "10%", left: "95%" }} />
          <span className="spark" style={{ bottom: "-10px", left: "30%" }} />
          <span className="spark gold" style={{ top: "55%", left: "-8%" }} />
          <span className="spark" style={{ bottom: "15%", right: "-6%" }} />
          <span className="spark" style={{ top: "-5px", left: "30%" }} />
          <span className="spark gold" style={{ top: "55%", left: "-8%" }} />
          <span className="spark gold" style={{ top: "-18px", left: "45%" }} />
          <span className="spark" style={{ top: "10%", left: "60%" }} />
          <span className="spark gold" style={{ top: "70%", left: "15%" }} />
          <span className="spark" style={{ top: "80%", right: "5%" }} />
          <span className="spark gold" style={{ bottom: "-6px", right: "42%" }} />
          <span className="spark" style={{ top: "-22px", right: "28%" }} />
          <span className="spark gold" style={{ bottom: "9%", left: "65%" }} />
        </h1>
